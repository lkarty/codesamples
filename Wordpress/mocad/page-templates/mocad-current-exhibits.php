<?php
/*
 * Template Name: Mocad Current Exhibits Page
 * Description: Current Exhibits page
 */
	...
	<?php 
		...
		while(have_posts()) {
			...
			while($exhibits->have_posts()) {
				...
				$author = get_field('exhibition_author_name', get_the_ID());
				$medium = get_field('exhibition_medium_' , get_the_ID());
